...
def main():
    ...
    if args.modality == 'image':
        ...
        if args.modality == 'book' or args.modality == 'humanEval' or args.use_bert_tokenizer == 'yes':
    ...
    print(f"lr = {args.lr}")
    print(f"ema_rate = {args.ema_rate}")
    ...
    print(f"fp16_scale_growth = {args.fp16_scale_growth}")
    print(f"schedule_sampler = {schedule_sampler}")
    print(f"weight_decay = {args.weight_decay}")
    print(f"lr_anneal_steps = {args.lr_anneal_steps}")
    print(f"checkpoint_path = {args.checkpoint_path}")
    print(f"gradient_clipping = {args.gradient_clipping}")
    print(f"eval_data = {data_valid}")
